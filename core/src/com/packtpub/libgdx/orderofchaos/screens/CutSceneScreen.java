...
import com.packtpub.libgdx.orderofchaos.EntityFactory;
import com.packtpub.libgdx.orderofchaos.Map;
import com.packtpub.libgdx.orderofchaos.MapFactory;
import com.packtpub.libgdx.orderofchaos.UI.AnimatedImage;
import com.packtpub.libgdx.orderofchaos.Utility;
import com.packtpub.libgdx.orderofchaos.audio.AudioObserver;
import com.packtpub.libgdx.orderofchaos.battle.MonsterFactory;
...
public class CutSceneScreen extends MainGameScreen {
    ...
    public CutSceneScreen(OrderOfChaos game) {
        super(game);
