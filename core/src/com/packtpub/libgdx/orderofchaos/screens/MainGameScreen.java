...
import com.packtpub.libgdx.orderofchaos.UI.PlayerHUD;
...
public class MainGameScreen extends GameScreen {
	...
	public MainGameScreen(OrderOfChaos game){
		_game = game;
	...
	public void render(float delta) {
		if( _gameState == GameState.GAME_OVER ){
			_game.setScreen(_game.getScreenType(OrderOfChaos.ScreenType.GameOver));
		}
