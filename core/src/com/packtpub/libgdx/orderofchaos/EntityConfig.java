...
import com.packtpub.libgdx.orderofchaos.Entity.AnimationType;
...
public class EntityConfig {
    ...
    private AbilityHitbox ability1Hitbox;
    ...
    EntityConfig(EntityConfig config){
        ...
        if(config.getAbility1HitboxVertices() != null) {
            ...
            ability1Hitbox = new AbilityHitbox(temp);
        }
    ...
    public AbilityHitbox getAbilty1Hitbox(){return ability1Hitbox;}

    public void setAbility1Hitbox(AbilityHitbox ability1Hitbox){this.ability1Hitbox = ability1Hitbox;}
